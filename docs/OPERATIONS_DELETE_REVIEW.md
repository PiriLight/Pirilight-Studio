...
Validado em PostgreSQL 17 isolado: eliminação das três entidades, bloqueio por dependências, recusa de utilizador inativo, versão desatualizada e preservação de auditoria. A ativação remota e publicação desta alteração continuam pendentes.
